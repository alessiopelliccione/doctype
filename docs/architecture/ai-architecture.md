...
| **`readme`** | *Not used* | *Not used* | **The Editor**: Reads all available context and rewrites the full `README.md`. | *Not used* | `package.json` + File Tree + Dependency Info + `git diff` |
