...
import { SintesiMap, SintesiMapEntry } from '../core/native-loader';
 ...
 */
export class SintesiMapManager {
  private mapFilePath: string;
  private map: SintesiMap;
   ...
   * @returns The loaded SintesiMap
   */
  private load(): SintesiMap {
    ...
    try {
      ...
      const map = JSON.parse(content) as SintesiMap;
   ...
   * @returns Array of all SintesiMapEntry objects
   */
  public getEntries(): SintesiMapEntry[] {
   ...
   */
  public getEntryById(id: string): SintesiMapEntry | undefined {
   ...
   */
  public getEntriesByCodeRef(filePath: string, symbolName: string): SintesiMapEntry[] {
   ...
   */
  public getEntriesByDocFile(filePath: string): SintesiMapEntry[] {
   ...
   */
  public addEntry(entry: SintesiMapEntry): void {
   ...
   */
  public updateEntry(id: string, updates: Partial<SintesiMapEntry>): void {
   ...
   */
  public getDriftedEntries(currentHashes: Map<string, string>): SintesiMapEntry[] {
    const drifted: SintesiMapEntry[] = [];
   ...
   * @returns A copy of the entire SintesiMap
   */
  public export(): SintesiMap {
    return {
